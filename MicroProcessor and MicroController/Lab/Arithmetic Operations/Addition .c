...
int main(void) {
    ...
    while(1) {
        ...
        // ====================================================
        // ADDITION OPERATION (Zero & Carry Flag Demo)
        // Condition: a + b = 0 (Z flag set)
        // ====================================================

        // Clear all APSR flags (N, Z, C, V, Q) by moving value zero to APRS_nzcvq 
        __asm volatile ("MSR APSR_nzcvq, %0" : : "r"(0) : "cc");
        
        int a = 5, b = -5;  // Result = 0 (Z flag set)
